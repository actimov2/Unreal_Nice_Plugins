...
| [x]    | M2.S2 | OptimizePrime | Extensibility pass: extract ICategoryProvider + add FNaniteEligibilityProvider + promote thresholds to UDeveloperSettings | Unreal_Nice_Plugins-o9b | docs/sectors/M2.S2.md |
